...
- 팀원 간 확인 동기화: 로컬 콘솔에서는 5초 간격 갱신으로 공유됩니다. 공개 사이트에서 함께 보려면 `npm run dev:shared` + `npm run tunnel` 후 `http://tap2.work/app/?api=<터널 주소>` 링크를 공유합니다([배포 문서](docs/DEPLOYMENT.md))
