...
function render() {
  ...
  document.title = `tap2work · ${({ overview: '프로젝트 현황', decisions: '결정사항', history: '개발 이력', preview: '앱 미리보기' })[route]}`;
}
